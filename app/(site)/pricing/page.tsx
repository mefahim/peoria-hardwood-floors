  ...
  return <>
    ...
    <main>
      <section className="container mx-auto grid gap-12 px-6 py-20 lg:grid-cols-[.85fr_1.15fr] lg:py-28">
        <div><p className="text-xs uppercase tracking-[0.24em] text-accent">What affects cost</p><h2 className="mt-4 font-serif text-4xl leading-tight md:text-5xl">Good pricing starts with the right questions.</h2><p className="mt-6 leading-relaxed text-muted-foreground">Square footage is only part of the story. We account for preparation, materials, access, details, and the finish you want so the recommendation fits the project—not just a calculator. The calculator is planning guidance; final scope and pricing are assessed for the specific space.</p><div className="mt-8 flex flex-wrap gap-5"><Link href="/estimate-calculator" className="inline-flex items-center gap-2 bg-foreground px-6 py-3 font-medium text-background">Try the estimate calculator <ArrowRight className="h-4 w-4" /></Link><Link href="/services" className="inline-flex items-center gap-2 font-medium">Review services <ArrowRight className="h-4 w-4" /></Link><Link href="/contact" className="inline-flex items-center gap-2 font-medium">Talk through your project <ArrowRight className="h-4 w-4" /></Link></div></div>
